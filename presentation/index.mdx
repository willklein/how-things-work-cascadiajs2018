import { Cite, Fill, Fit, Image, Notes } from 'spectacle'
import { ExplorerSlide, DarkSlide, LightSlide, ProfileSlide, CodeSlide, DrillSlide, TitleSlide, TitleImageSlide, LatheSlide, WorkshopSlide, WorkshopTitleSlide, MachineSlide} from './slides'
...
<Image src="eslint.svg" width={1000} />

...
import { NeoSlide, KungFuSlide, ExplorerSlide, DarkSlide, LightSlide, ProfileSlide, CodeSlide, DrillSlide, TitleSlide, TitleImageSlide, LatheSlide, WorkshopSlide, ToolWallBackgroundSlide, WorkshopTitleSlide, MachineSlide, CiteTiny, CascadiaExplorerSlide } from './slides'
...
<Notes>
  Remember our problems? We CAN save time, and automate our code reviews.
</Notes>
...
async function getData() {
  await api.request({
    method: 'GET',
    count: Infinity,
    /* get ALL the data... what could go wrong */
  })
}
```
...
<Notes>
  the next time JavaScript has a new feature, you swap one of your libraries or a framework has breaking changes, or even if you have shared code with breaking changes and lots of usages, write a code mod
</Notes>

---

<Image src="github-issue.png" width={1000} />
...
```javascript
// Glamorous
const BorderedInput = glamorous.input({
  border: "0.5px solid #EBF0F5",
  borderRadius: 2,
})
...
<Image src="emotion-codemod.png" width={1000} />
...
> There was this new thing called ES6  _... There was a large gap in my knowledge on parsers, compilers and generally the intracacies of JavaScript..._ so I decided to make an ES6 transpiler to learn it, called 6to5.
...
export default ToolWallBackgroundSlide
...
<Notes>
  Now ... I'm not about to go out and write my own JavaScript compiler, but thanks to tools like Babel, ESLint, and AST Explorer, we can write plugins that do really cool things.
</Notes>
